...
namespace FigursLibrary
{
    ...
    public class Triangles
    {
        ...
        //Добавление новой фигуры, как можно видеть выше, необходимо создать public class тип_фигуры, чтобы обьявить класс для новой фигры, а дальше создавать внутри класса методы для вычислений.
    }
}
